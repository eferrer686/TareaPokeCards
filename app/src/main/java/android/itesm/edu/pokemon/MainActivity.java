...
import android.itesm.edu.pokemon.adapters.PokemonRecyclerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void setRecyclerView(List<PokeCard>pokeCards){
        PokemonRecyclerAdapter pokemonRecyclerAdapter = new PokemonRecyclerAdapter(this,pokeCards);
